...
if (!empty($search)) {
    $sql .= " AND (e.book_name LIKE ? OR e.author LIKE ?)";
    $searchParam = "%$search%";
    $params[] = $searchParam;
    $params[] = $searchParam;
    $types .= "ss";
...
<div class="container">
    <h1 class="page-book_name">E-Books Library</h1>

    <div class="search-section mb-4">
        <form action="" method="GET" class="search-form">
            <div class="search-row">
                <div class="search-input-group">
                    <input type="text" name="search" placeholder="Search e-books by book_name or author..." 
                ...
                <div class="ebook-card">
                    <div class="ebook-cover">
                        <?php if (!empty($ebook['cover_image'])): ?>
                            <img src="<?php echo htmlspecialchars($ebook['cover_image']); ?>" alt="<?php echo htmlspecialchars($ebook['book_name']); ?>">
                        <?php else: ?>
                    ...
                    <div class="ebook-info">
                        <h3 class="ebook-book_name"><?php echo htmlspecialchars($ebook['book_name']); ?></h3>
...
<div class="modal-overlay" id="ebookModal">
    <div class="modal ebook-modal">
        <div class="modal-header">
            <h3 class="modal-book_name">E-book Details</h3>
                ...
                modalContent.innerHTML = `
                    <div class="ebook-detail-content">
                        <div class="detail-header">
                            ...
                            <div class="detail-book_name">
                                <h4>${ebook.book_name}</h4>
                                <p>By ${ebook.author}</p>
                            </div>
                        </div>
